...
import com.medicology.assessment.security.jwt.JWTDecoder;
    ...
    protected void doFilterInternal(
        ...
        try {
            if (SecurityContextHolder.getContext().getAuthentication() == null && jwtDecoder.isTokenValid(jwt, "access")) {
                ...
                UserPrincipal principal = new UserPrincipal(userId, subject, admin);
            ...
            log.warn("jwt_authentication_failed path={} message={}", request.getRequestURI(), exception.getMessage());
        }
